...
| >CO₃H⁰ + Co²⁺ ⇌ >CO₃Co⁺ + H⁺ | 2 | **≥ −2.20** (lower bound) | (−2.24) | 0.20 | ±1.16 random only | both points pre-equilibrium (pH 6 batch, days 2 and 4) and uptake still rising at day 6; log K increases monotonically with coverage, so the fitted value bounds the constant from below |
